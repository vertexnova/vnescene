...
def interactive_mode(config: BuildConfig):
    print("=== VneScene Interactive Build Configuration ===")
...
def build_cmake_command(project_root: Path, build_type: str) -> List[str]:
    return [
        ...
        "-DVNE_SCENE_TESTS=ON", str(project_root),
    ]
...
def main():
    parser = argparse.ArgumentParser(description="Build VneScene for Windows")
