...
build_cmake_command() {
  ...
  if [ "$COMPILER" = "gcc" ]; then
    base_cmd="cmake -DCMAKE_BUILD_TYPE=$BUILD_TYPE -DVNE_SCENE_LIB_TYPE=$LIB_TYPE -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ -DVNE_SCENE_TESTS=ON"
  elif [ "$COMPILER" = "clang" ]; then
    base_cmd="cmake -DCMAKE_BUILD_TYPE=$BUILD_TYPE -DVNE_SCENE_LIB_TYPE=$LIB_TYPE -DCMAKE_C_COMPILER=clang -DCMAKE_CXX_COMPILER=clang++ -DVNE_SCENE_TESTS=ON"
  fi
