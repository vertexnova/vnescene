#==============================================================================
# VneScene Windows Build Script (PowerShell)
#==============================================================================
...
$ConfigureCmd = "cmake -B `"$BuildDir`" -S `"$ProjectRoot`" -DCMAKE_BUILD_TYPE=$BuildType -DVNE_SCENE_LIB_TYPE=$LibType -DVNE_SCENE_TESTS=ON $Generator"
