...
This directory holds external and internal dependencies for VneScene.
...
VneScene’s `.gitmodules` already defines all four submodules:
...
**In this repo (VneScene):** `.gitmodules` already lists these paths. Just run from the project root:
